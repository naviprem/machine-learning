...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing == True:
            ...
            # self.epsilon = self.epsilon - 0.05 #linear decay function
            # self.epsilon = math.exp(-0.005 * self.trial) #exponential decay function
            self.epsilon = (math.cos(0.005 * self.trial) / 2) + 0.5 #cosine decay function
            # self.epsilon = 1 - (1 / (1 + math.exp(-0.2 * self.alpha * (self.trial - 0.5))))
            self.trial += 1
    ...
    def get_maxQ(self, state):
        ...
        # max_q_value = state_q[max(state_q)]
        # max_actions = [max(state_q)]
        # for k, v in state_q.iteritems():
        #     if v > max_q_value:
        #         max_q_value = v
        #         max_actions = []
    ...
    def choose_action(self, state):
        ...
        if not self.learning:
            ...
            # print "Explore Action: ", state
        else:
            # print "random.random: ", random.random()
            # print "1 - self.epsilon: ", 1 - self.epsilon
